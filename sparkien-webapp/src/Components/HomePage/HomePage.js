...
const HomePageSm = () => {
    return(
        <>
        <div className='flex justify-center align-center w-full mt-3'>
            <div className='flex flex-col gap-2 border rounded-md shadow-lg'>
                ...
                <div className='flex flex-col mt-5 p-5 gap-2 justify-center'>
                <h1 className='flex font-serif font-bold text-3xl text-[#2D31FA]'>Is there something you forgot?</h1>
                    <h2 className='flex font-serif text-2xl justify-center'>Are you a person who requires someone to remind about your tasks?</h2>
                    <h1 className='flex font-serif text-2xl mt-5 justify-center'>Don't worry! <span className='font-serif font-bold text-3xl text-[#2D31FA] mx-2'>Daily Reminder</span> is there to remind you everything!</h1>
                    <h1 className='flex font-serif text-2xl mt-5 justify-center'>Just <span className='font-serif font-bold text-2xl text-[#2D31FA] mx-2'> SignUp</span> to add you tasks and get relieved</h1>
                    <button className="flex font-semibold text-xl rounded-full bg-[#2D31FA] px-3 py-2 text-white w-[150px] mt-5 hover:shadow-lg delay-200 justify-center">SignUp</button>
                </div>
            </div>
        ...
        <div className='flex justify-center align-center w-full mt-10'>
            <div className='flex flex-row gap-5 border rounded-md shadow-lg'>
                ...
                <div className='flex flex-col p-5 gap-2'>
                    ...
                    <button className="font-semibold text-xl rounded-full bg-[#2D31FA] px-3 py-2 text-white w-[150px] mt-5 hover:shadow-lg delay-200">SignUp</button>
                </div>
            </div>
        </div>
        </>
